async function instantiate(module, imports = {}) {
  ...
  const adaptedExports = Object.setPrototypeOf(
    {
      ajax(u, f, t) {
        // assembly/index/ajax(~lib/string/String, ~lib/string/String, ~lib/string/String) => ~lib/string/String
        u = __retain(__lowerString(u) || __notnull());
        f = __retain(__lowerString(f) || __notnull());
        t = __lowerString(t) || __notnull();
        try {
          return __liftString(exports.ajax(u, f, t) >>> 0);
        } finally {
          __release(u);
          __release(f);
        }
